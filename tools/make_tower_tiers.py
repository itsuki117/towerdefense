...
TIERS = [
    {
        ...
        "cost": 50, "damage": 4, "range": 6.0, "rate": 1.6, "speed": 18.0,
        "color": (0.85, 0.72, 0.35), "upgrade": 150,
    },
    {
        "file": "tower_cannon", "name": "キャノンタワー", "model": "tower_cannon",
        "mount": 0.4473, "muzzle": (0.09, 0.188, -0.898),
        "cost": 62, "damage": 7, "range": 6.5, "rate": 1.6, "speed": 19.0,
        "color": (0.88, 0.66, 0.32), "upgrade": 240,
    },
    {
        "file": "tower_heavy", "name": "ヘビータワー", "model": "tower_heavy",
        "mount": 0.6152, "muzzle": (0.09, 0.19, -0.996),
        "cost": 76, "damage": 11, "range": 7.0, "rate": 1.7, "speed": 20.0,
        "color": (0.92, 0.6, 0.3), "upgrade": 380,
    },
    {
        "file": "tower_siege", "name": "シージタワー", "model": "tower_siege",
        "mount": 0.808, "muzzle": (0.09, 0.1915, -1.175),
        "cost": 92, "damage": 16, "range": 7.5, "rate": 1.7, "speed": 21.0,
        "color": (0.96, 0.56, 0.3), "upgrade": 560,
    },
    {
        "file": "tower_apex", "name": "エイペックスタワー", "model": "tower_apex",
        "mount": 0.975, "muzzle": (0.0, 0.25, -1.345),
        "cost": 110, "damage": 22, "range": 8.0, "rate": 1.8, "speed": 22.0,
