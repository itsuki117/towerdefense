...
ENEMY_TYPES = {
    ...
    "boss": ("enemy_boss", 140),
    # 倒すと「こぶんスライム」3 体に分かれる。子のぶんの撃破ゴールドはここに含めない
    # （見積もりが 4 倍にぶれるので、分裂ぶんは収入の余禄として扱う）。
    "splitter": ("enemy_splitter", 10),
}
...
STAGES = {
    ...
    2: [
        ...
        {"normal": (15, 0.85), "fast": (9, 0.75, 2.5), "armored": (3, 1.4, 4.0), "splitter": (1, 1.6, 5.0), "hp": 1.8, "delay": 4.5},
        {"normal": (17, 0.8), "fast": (12, 0.7, 2.5), "armored": (4, 1.4, 4.0), "splitter": (2, 1.6, 5.0), "hp": 2.0, "delay": 4.5},
        {"normal": (20, 0.7), "fast": (15, 0.6, 2.0), "armored": (5, 1.4, 4.0), "splitter": (2, 1.5, 4.5), "hp": 2.1, "delay": 4.0},
        {"normal": (23, 0.65), "fast": (19, 0.55, 2.0), "armored": (6, 1.4, 4.0), "splitter": (3, 1.5, 4.5), "boss": (1, 3.0, 8.0), "hp": 2.3, "delay": 4.0},
    ],
    ...
    3: [
        ...
        {"normal": (13, 0.85), "fast": (9, 0.75, 2.0), "armored": (4, 1.4, 4.0), "splitter": (1, 1.6, 5.0), "hp": 3.2, "delay": 4.5},
        {"normal": (15, 0.8), "fast": (11, 0.7, 2.0), "armored": (5, 1.4, 4.0), "splitter": (1, 1.6, 5.0), "hp": 3.4, "delay": 4.5},
        {"normal": (18, 0.75), "fast": (14, 0.65, 2.0), "armored": (5, 1.4, 4.0), "splitter": (2, 1.5, 4.5), "hp": 3.5, "delay": 4.5},
        {"normal": (20, 0.7), "fast": (17, 0.6, 2.0), "armored": (6, 1.4, 4.0), "splitter": (2, 1.5, 4.5), "hp": 3.6, "delay": 4.0},
        {"normal": (23, 0.65), "fast": (20, 0.55, 1.5), "armored": (7, 1.4, 4.0), "splitter": (2, 1.4, 4.0), "boss": (1, 3.0, 8.0), "hp": 3.7, "delay": 4.0},
        {"normal": (26, 0.6), "fast": (24, 0.5, 1.5), "armored": (8, 1.4, 4.0), "splitter": (2, 1.4, 4.0), "hp": 3.8, "delay": 3.5},
        {"normal": (31, 0.55), "fast": (29, 0.45, 1.5), "armored": (9, 1.4, 4.0), "splitter": (2, 1.3, 4.0), "boss": (1, 3.0, 8.0), "hp": 3.9, "delay": 3.5},
    ],
}
